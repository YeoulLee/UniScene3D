...
# ==== USER SETTINGS ====
# One-shot full fine-tuning: projector + Qwen3.5-4B trained together, with
# DeepSpeed ZeRO-2 sharding the optimizer states across GPUs.
CONFIG="configs/finetune/sqa3d_qwen3d.yaml"
DS_CONFIG="configs/deepspeed_zero2.json"
NOTE="sqa3d_qwen3d_full_run1"
EXP_NAME="sqa3d_qwen3d_full_run1"
GPUS=8
cd "${PROJECT_ROOT}"
...
echo "[INFO] Full fine-tuning (DeepSpeed ZeRO-2): $EXP_NAME"
